        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 bg-black">
            ...
            <div className="col-span-2 px-5 my-auto">
                ...
                <div className="my-8">
                    ...
                    <a href="/" className="px-6 py-3 w-full rounded-xl mr-4 border border-gray-400 hover:bg-gradient-to-tr from-orange-500 to-pink-500 text-white hover:border-none">
                        Contact</a>
                </div>
            </div>
        </div>
