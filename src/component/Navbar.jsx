        ...
        <div>
            <div className='bg-black text-gray-400 h-[100px] flex justify-between items-center'>
                ...
                <ul className='hidden md:flex'>
                    <li className="p-5"><a href="mailto:doquanglong280504@gmail.com?subject=Contact from Portfolio">Contact</a></li>
                ...
                <ul className='p-8 text-2xl'>
                    <li className="p-2"><a href="mailto:doquanglong280504@gmail.com?subject=Contact from Portfolio">Contact</a></li>
